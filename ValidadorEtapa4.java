public class ValidadorEtapa4 {
    ...
    public static void main(String[] args){
        ...
        Loja loja2 = new Loja ("E7", 20, e1, d1, 2);
        ...
        //public void setDataDeFundacao(Data dataFundacao);
        loja1.setDataDeFundacao(new Data(10, 8, 2020));
        System.out.println("[OK] Método Loja.setDataDeFundacao()");

        //public Produto[] getEstoqueProdutos();
        System.out.println(loja1.getEstoqueProdutos().length == 2 ? "[OK] Método Loja.getEstoqueProdutos()" : "[NOK] Método Loja.getEstoqueProdutos()");
        ...
        //public void setEndereco(Endereco endereco)
        Endereco e2 = new Endereco("Rua das Flores", "15","null","91000-100","Porto Alegre","RS", "Brasil");
